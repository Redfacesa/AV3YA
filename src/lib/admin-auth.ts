...
import { isAv3yaAdmin, type Av3yaPlatformConfig } from './platform-config';
...
export function isAllowedAdmin(session: AdminSession | null, config: Av3yaPlatformConfig): boolean {
  return isAv3yaAdmin(session?.email, config);
}
